...
export class ProfileComponent implements OnInit {
  ...
  updatedUser: Partial<User> = { DateOfBirth: new Date(), IdentityCardNumber: '' };  // Initialize properties
  ...
  loadUserProfile(): void {
    ...
    this.userService.getUserProfile(userId).subscribe(
      (user: User) => {
        this.user = user;
        this.updatedUser = { DateOfBirth: user.DateOfBirth, IdentityCardNumber: user.IdentityCardNumber };  // Initialize updatedUser
      },
      (error) => {
